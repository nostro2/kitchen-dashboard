...
Exec=bash -c 'sleep 15 && unclutter -idle 0.1 -root & DISPLAY=:0 xdotool mousemove 0 99999 & rm -rf ~/.cache/mozilla/firefox/*/cache2 && firefox --kiosk --private-window http://localhost:${PORT}'
EOF
